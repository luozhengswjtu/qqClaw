...
export const lobsterCheckIns: CheckInItem[] = [
  ...
  {
    id: 'first_enable_mentions',
    title: '生成群聊总结卡',
    description: '把授权群里的重点和相关 @ 放进同一张可切换卡片。',
    status: 'locked',
  },
  {
    id: 'first_view_mentions',
    title: '查看群聊总结卡',
    description: '打开小龙虾整理出的可切换群聊总结卡。',
    status: 'locked',
    rewardId: 'mention-pin',
  },
  {
    id: 'first_jump_source',
    title: '跳转消息来源',
    description: '从卡片一键回到原始群消息。',
    status: 'locked',
  },
  {
    id: 'first_group_summary',
    title: '查看群聊摘要',
    description: '在群聊总结卡里查看授权群聊的简短摘要。',
    status: 'locked',
    rewardId: 'summary-badge',
  },
  {
    id: 'first_reply_draft',
    title: '生成回复草稿',
    description: '让小龙虾给出一条可复制到群聊里的回复草稿。',
    status: 'locked',
  },
  {
